...
<div class = "float-container">
<div class='buttons'>
	<button style="color: black; background-color:cornflowerblue" on:click={create} disabled="{!petType || !price}">Add</button>
	<button style="color: black; background-color:cornflowerblue" on:click={update} disabled="{!petType || !price || !selected}">Update</button>
	<button style="color: black; background-color:cornflowerblue" on:click={remove} disabled="{!selected}">Delete</button>
</div>
</div>
</div>
